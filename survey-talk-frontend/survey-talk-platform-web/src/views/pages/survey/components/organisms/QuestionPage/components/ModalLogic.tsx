...
function ModalLogic({
  ...
  const getOperatorsForQuestion = (QuestionTypeId: number): OperatorType[] => {
      ...
      <div className="bg-white rounded-lg w-[90%] max-w-3xl max-h-[90vh] flex flex-col">
        <div className="p-6 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-600">
            Thêm điều kiện để chuyển hướng người dùng đến câu hỏi khác
          </p>
        </div>
            ...
            >
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex gap-2">
                  <button
                    onClick={() => handleAddCondition(logicIndex)}
              ...
              <div className="space-y-3">
                {logic.Conditions.map((condition, conditionIndex) => (
                  ...
                  >
                    ...
                    >
                      ...
                      {condition.QuestionId &&
                        getOperatorsForQuestion(
                          questions.find((q) => q.Id === condition.QuestionId)
                            ?.QuestionTypeId || 0
                        ).map((op) => (
                    ...
                    <button
                      onClick={() =>
                        handleDeleteCondition(logicIndex, conditionIndex)
                      }
                ...
                <div className="flex items-center gap-3">
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      ...
                      const newLogics = [...JumpLogics];
                      newLogics[logicIndex] = updatedLogic;
                      handleUpdateQuestion("ConfigJson", {
                        ...configJson,
                        JumpLogics: newLogics,
                      });
