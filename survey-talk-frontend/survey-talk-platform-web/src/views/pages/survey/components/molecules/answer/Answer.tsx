...
import type { OptionType, SurveyType } from "@/core/types/tools";
import "./styles.scss";
  ...
  const handleImageUpload = (event: ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        ...
        handleUpdateOption({ ...data, MainImageBase64: base64String }); //Thịnh, file này đổi các Image thành MainImageBase64
