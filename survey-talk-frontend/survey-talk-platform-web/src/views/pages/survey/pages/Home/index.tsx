...
const projectsData = [
  ...
  },
  {
    ...
    title:
      "Cung cấp phần mềm khảo sát để khách hàng tự thực hiện khảo sát thị trường Offline",
  ...
  },
  {
    category: "Phần mềm khảo sát",
    title:
      "Cung cấp phần mềm khảo sát trực tuyến để khảo sát trải nghiệm người dùng trên trang Oto.com.vn",
  ...
  },
  {
    category: "Phần mềm khảo sát",
    title:
      "Cung cấp công cụ bình chọn cho sự kiện lớn Tinh tế Bình Chọn hàng năm",
    logoSrc: logoTinhte,
    barColorClass: "survey-software",
  },
  {
    ...
    title:
      "Cung cấp nền tảng tạo đề thi trắc nghiệm trực tuyến để giáo viên làm kiểm tra 15p và 1 tiết",
  ...
  },
  {
    category: "Trắc nghiệm online",
    title:
      "Cung cấp nền tảng tạo bài kiểm tra tiếng Anh đầu vào trong tuyển dụng nhân sự ở công ty Sonion",
    logoSrc: logoSonion,
    barColorClass: "online-quiz",
  },
  {
    category: "Trắc nghiệm online",
    title:
      "Cung cấp nền tảng tạo bài kiểm tra nghiệp vụ dựa trên ngân hàng câu hỏi cho Bảo Việt Nhân Thọ",
  ...
  },
  {
    ...
    title:
      "Xây dựng hệ thống VOC (Voice of Customer) khảo sát khách hàng tại chuỗi siêu thị MM Mega Market",
  ...
  },
  {
    category: "Khảo sát khách hàng",
    title:
      "Xây dựng hệ thống khảo sát khách hàng cho chuỗi nhà hàng đồ nướng Hana BBQ",
    logoSrc: logoHanaBbq,
    barColorClass: "customer-survey",
  },
  {
    ...
    title:
      "Khảo sát nội bộ 3000 nhân viên MM Mega Market bằng link khảo sát có mật khẩu truy cập",
    logoSrc: logoMmMegaMarket,
    ...
    <MainTemPlate>
      <div className="home-page">
        ...
        <section className="home-banner flex flex-col md:flex-row items-center justify-between gap-8 px-8 py-12">
          <div className="flex-1 flex flex-col gap-4">
            ...
            <p className="home-desc">
              Phần mềm tạo khảo sát trực tuyến miễn phí, giao diện đẹp, dễ sử
              dụng trên nhiều thiết bị. Nền tảng nghiên cứu thị trường hoàn toàn
              tự động giúp tiết kiệm thời gian và chi phí.
            </p>
            <button
              className="home-btn"
          ...
          <div className="flex-1 flex justify-center">
            <img src={landingImg} alt="Landing" className="home-landing-img" />
          </div>
        </section>

        {/* Customers */}
        <section className="home-customers flex flex-col items-center py-12">
          <h3 className="home-customers-title">KHÁCH HÀNG CỦA CHÚNG TÔI</h3>
        ...
        <section className="home-projects-section flex flex-col items-center py-12">
          <h3 className="home-section-title">CÁC DỰ ÁN ĐÃ THỰC HIỆN</h3>
